...
workfile1 = DATA_PATH + 'user_input_data2.csv' # 'Demo_textdata2.csv' #入力ファイル：main01の結果または単純なCSVファイル
workfile2 = DATA_PATH + 'user_input_data3b.csv' # 'Demo_textdata3b.csv' #出力ファイル
